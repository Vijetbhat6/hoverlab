...
export const TEMPLATE_PALETTES: TemplatePalette[] = [
  ...
  /* ---------------------------------------------------------------- *
   *  Genre palettes -- templates 22-32
   *
   *  Eleven more, and by this point the obvious hues are gone. Which
   *  makes the point the header of this file already argues: hue is
   *  not what separates two palettes. Tideline and Harbour share a
   *  hue and are not remotely the same colour scheme, because one is
   *  at 45% chroma with a 1.5rem radius and the other is at 88% with
   *  0.625. Saturation and radius did most of the work here.
   *
   *  Two are deliberately near-neutral with a near-black primary --
   *  Linen and Carbon. That shape exists because a resume and an
   *  open-source README are both pages where a coloured button would
   *  be competing with the only content that matters.
   * ---------------------------------------------------------------- */
  {
    id: 'phosphor',
    name: 'Phosphor',
    note: 'High-chroma green on a near-white that is faintly cool, with corners almost square. The palette a terminal would pick if it had to render a CV — and the sharp radius is what separates it from Signal, which uses a neighbouring hue at the opposite extreme.',
    radiusRem: 0.125,
    light: {
      background: '150 42% 99%',
      foreground: '150 45% 9%',
      card: '0 0% 100%',
      'card-foreground': '150 45% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '150 45% 9%',
      primary: '150 85% 27%',
      'primary-foreground': '0 0% 100%',
      secondary: '150 42% 96%',
      'secondary-foreground': '150 40% 20%',
      muted: '150 28% 96%',
      'muted-foreground': '150 12% 41%',
      accent: '168 60% 95%',
      'accent-foreground': '168 50% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '150 28% 90%',
      input: '150 28% 90%',
    ...
    dark: {
      ...
      'secondary-foreground': '150 15% 97%',
      muted: '150 25% 15%',
      'muted-foreground': '150 12% 68%',
      accent: '168 30% 18%',
      'accent-foreground': '168 40% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '150 22% 19%',
      input: '150 22% 19%',
  ...
  },
  {
    id: 'linen',
    name: 'Linen',
    note: 'Warm paper, barely any chroma, and a near-black primary rather than a coloured one. Square corners throughout. Built to be printed: it is the only palette here whose light mode is the design and whose dark mode is the accommodation.',
    radiusRem: 0.0,
    light: {
      background: '35 12% 99%',
      foreground: '35 14% 9%',
      ...
      'primary-foreground': '0 0% 100%',
      secondary: '35 14% 96%',
      'secondary-foreground': '35 14% 20%',
      muted: '35 12% 96%',
      'muted-foreground': '35 12% 42%',
      accent: '28 14% 95%',
      'accent-foreground': '28 14% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '35 12% 90%',
      input: '35 12% 90%',
    ...
    dark: {
      ...
      foreground: '35 15% 97%',
      card: '35 14% 8%',
      'card-foreground': '35 15% 97%',
      popover: '35 14% 8%',
      'popover-foreground': '35 15% 97%',
      primary: '35 14% 78%',
      'primary-foreground': '35 14% 8%',
      secondary: '35 14% 15%',
      'secondary-foreground': '35 15% 97%',
      muted: '35 14% 15%',
      'muted-foreground': '35 12% 68%',
      accent: '28 14% 18%',
      'accent-foreground': '28 14% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '35 14% 19%',
      input: '35 14% 19%',
  ...
  },
  {
    id: 'vault',
    name: 'Vault',
    note: 'Deep teal on a cold near-white. The one hue no other palette in this set occupies, which is why it went to the exchange — finance reads as blue everywhere and teal is the nearest thing to blue that is not already spoken for.',
    radiusRem: 0.375,
    light: {
      background: '182 39% 99%',
      foreground: '182 45% 9%',
      card: '0 0% 100%',
      'card-foreground': '182 45% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '182 45% 9%',
      primary: '182 78% 28%',
      'primary-foreground': '0 0% 100%',
      secondary: '182 39% 96%',
      'secondary-foreground': '182 40% 20%',
      muted: '182 26% 96%',
      'muted-foreground': '182 12% 41%',
      accent: '196 60% 95%',
      'accent-foreground': '196 50% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '182 26% 90%',
      input: '182 26% 90%',
    ...
    dark: {
      background: '182 40% 5%',
      foreground: '182 15% 97%',
      card: '182 32% 8%',
      'card-foreground': '182 15% 97%',
      popover: '182 32% 8%',
      'popover-foreground': '182 15% 97%',
      primary: '182 88% 72%',
      'primary-foreground': '182 45% 8%',
      secondary: '182 25% 15%',
      'secondary-foreground': '182 15% 97%',
      muted: '182 25% 15%',
      'muted-foreground': '182 12% 68%',
      accent: '196 30% 18%',
      'accent-foreground': '196 40% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '182 22% 19%',
      input: '182 22% 19%',
  ...
  },
  {
    id: 'marquee',
    name: 'Marquee',
    note: 'Saturated magenta with the roundest corners in the set. Loud on purpose: a conference is a thing that happens once, on a date, and the page selling it is allowed to raise its voice in a way a product page is not.',
    radiusRem: 1.25,
    light: {
      background: '300 34% 99%',
      foreground: '300 45% 9%',
      card: '0 0% 100%',
      'card-foreground': '300 45% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '300 45% 9%',
      primary: '300 68% 34%',
      'primary-foreground': '0 0% 100%',
      secondary: '300 34% 96%',
      'secondary-foreground': '300 40% 20%',
      muted: '300 22% 96%',
      'muted-foreground': '300 12% 42%',
      accent: '318 60% 95%',
      'accent-foreground': '318 50% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '300 22% 90%',
      input: '300 22% 90%',
    ...
    dark: {
      background: '300 40% 5%',
      foreground: '300 15% 97%',
      card: '300 32% 8%',
      'card-foreground': '300 15% 97%',
      popover: '300 32% 8%',
      'popover-foreground': '300 15% 97%',
      primary: '300 78% 72%',
      'primary-foreground': '300 45% 8%',
      secondary: '300 25% 15%',
      'secondary-foreground': '300 15% 97%',
      muted: '300 25% 15%',
      'muted-foreground': '300 12% 68%',
      accent: '318 30% 18%',
      'accent-foreground': '318 40% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '300 22% 19%',
      input: '300 22% 19%',
  ...
  },
  {
    id: 'laurel',
    name: 'Laurel',
    note: 'Deep green on warm cream, square-cornered. Sits between Moss and Fern on hue and apart from both on background temperature — the cream is what makes it read as a dining room rather than as an eco-brand.',
    radiusRem: 0.125,
    light: {
  ...
  },
  {
    id: 'heath',
    name: 'Heath',
    note: 'Muted olive at about half the chroma of Moss. Understated on purpose: an estate agency that shouts in colour is telling you something about how it values a house.',
    radiusRem: 0.5,
    light: {
      background: '88 19% 99%',
      foreground: '88 38% 9%',
      card: '0 0% 100%',
      'card-foreground': '88 38% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '88 38% 9%',
      primary: '88 38% 34%',
      'primary-foreground': '0 0% 100%',
      secondary: '88 19% 96%',
      'secondary-foreground': '88 38% 20%',
      muted: '88 12% 96%',
      'muted-foreground': '88 12% 40%',
      accent: '108 38% 95%',
      'accent-foreground': '108 38% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '88 12% 90%',
      input: '88 12% 90%',
    ...
    dark: {
      ...
      foreground: '88 15% 97%',
      card: '88 32% 8%',
      'card-foreground': '88 15% 97%',
      popover: '88 32% 8%',
      'popover-foreground': '88 15% 97%',
      primary: '88 48% 72%',
      'primary-foreground': '88 38% 8%',
      secondary: '88 25% 15%',
      'secondary-foreground': '88 15% 97%',
      muted: '88 25% 15%',
      'muted-foreground': '88 12% 68%',
      accent: '108 30% 18%',
      'accent-foreground': '108 38% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '88 22% 19%',
      input: '88 22% 19%',
  ...
  },
  {
    id: 'foundry',
    name: 'Foundry',
    note: 'Desaturated indigo, nearly a slate, with a small radius. Iris occupies a neighbouring hue at twice the chroma; this one is what that colour looks like when the page is a list of other people’s jobs rather than a product.',
    radiusRem: 0.25,
    light: {
  ...
  },
  {
    id: 'tideline',
    name: 'Tideline',
    note: 'Soft cyan and the largest radius in the catalog. Harbour is the same hue at nearly double the saturation and a quarter of the roundness — the two are a good demonstration that hue alone does not separate two palettes.',
    radiusRem: 1.5,
    light: {
  ...
  },
  {
    id: 'carbon',
    name: 'Carbon',
    note: 'A near-neutral grey with a violet cast and a near-black primary. The palette an open-source project converges on because it stays out of the way of a code sample, which is the only thing on the page anybody came for.',
    radiusRem: 0.25,
    light: {
      background: '260 12% 99%',
      foreground: '260 12% 9%',
      card: '0 0% 100%',
      'card-foreground': '260 12% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '260 12% 9%',
      primary: '260 12% 16%',
      'primary-foreground': '0 0% 100%',
      secondary: '260 14% 96%',
      'secondary-foreground': '260 12% 20%',
      muted: '260 12% 96%',
      'muted-foreground': '260 12% 42%',
      accent: '276 12% 95%',
      'accent-foreground': '276 12% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '260 12% 90%',
      input: '260 12% 90%',
    ...
    dark: {
      ...
      primary: '260 12% 78%',
      'primary-foreground': '260 12% 8%',
      secondary: '260 12% 15%',
      'secondary-foreground': '260 15% 97%',
      muted: '260 12% 15%',
      'muted-foreground': '260 12% 68%',
      accent: '276 12% 18%',
      'accent-foreground': '276 12% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '260 12% 19%',
      input: '260 12% 19%',
  ...
  },
  {
    id: 'mulberry',
    name: 'Mulberry',
    note: 'Dusty purple-red at moderate chroma. Plum is the neighbouring hue, louder and rounder; this is the version that can sit behind a thousand-row index without tiring the eye.',
    radiusRem: 0.625,
    light: {
      background: '318 27% 99%',
      foreground: '318 45% 9%',
      card: '0 0% 100%',
      'card-foreground': '318 45% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '318 45% 9%',
      primary: '318 55% 34%',
      'primary-foreground': '0 0% 100%',
      secondary: '318 27% 96%',
      'secondary-foreground': '318 40% 20%',
      muted: '318 18% 96%',
      'muted-foreground': '318 12% 42%',
      accent: '336 55% 95%',
      'accent-foreground': '336 50% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '318 18% 90%',
      input: '318 18% 90%',
    ...
    dark: {
      background: '318 40% 5%',
      foreground: '318 15% 97%',
      card: '318 32% 8%',
      'card-foreground': '318 15% 97%',
      popover: '318 32% 8%',
      'popover-foreground': '318 15% 97%',
      primary: '318 65% 72%',
      'primary-foreground': '318 45% 8%',
      secondary: '318 25% 15%',
      'secondary-foreground': '318 15% 97%',
      muted: '318 25% 15%',
      'muted-foreground': '318 12% 68%',
      accent: '336 30% 18%',
      'accent-foreground': '336 40% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '318 22% 19%',
      input: '318 22% 19%',
  ...
  },
  {
    id: 'nocturne',
    name: 'Nocturne',
    note: 'Deep blue-violet, and the one palette in this set designed dark-first — its light mode is the accommodation. Everything about a streaming product happens on a dark surface, including the player, which is dark in both themes regardless.',
    radiusRem: 0.875,
    light: {
      background: '228 32% 99%',
      foreground: '228 45% 9%',
      card: '0 0% 100%',
      'card-foreground': '228 45% 9%',
      popover: '0 0% 100%',
      'popover-foreground': '228 45% 9%',
      primary: '228 65% 34%',
      'primary-foreground': '0 0% 100%',
      secondary: '228 32% 96%',
      'secondary-foreground': '228 40% 20%',
      muted: '228 21% 96%',
      'muted-foreground': '228 12% 42%',
      accent: '248 60% 95%',
      'accent-foreground': '248 50% 22%',
      destructive: '0 72% 45%',
      'destructive-foreground': '0 0% 100%',
      border: '228 21% 90%',
      input: '228 21% 90%',
    ...
    dark: {
      background: '228 40% 5%',
      foreground: '228 15% 97%',
      card: '228 32% 8%',
      'card-foreground': '228 15% 97%',
      popover: '228 32% 8%',
      'popover-foreground': '228 15% 97%',
      primary: '228 75% 72%',
      'primary-foreground': '228 45% 8%',
      secondary: '228 25% 15%',
      'secondary-foreground': '228 15% 97%',
      muted: '228 25% 15%',
      'muted-foreground': '228 12% 68%',
      accent: '248 30% 18%',
      'accent-foreground': '248 40% 92%',
      destructive: '0 62% 52%',
      'destructive-foreground': '0 0% 100%',
      border: '228 22% 19%',
      input: '228 22% 19%',
