...
export const PAGE_CATALOG: PageRecord[] = [
   ...
   *  Genre pages
   *
   *  The categories every competing template library covers and this
   *  catalog did not: developer portfolio and resume, crypto and
   *  fintech, conference, restaurant, property, job board, newsletter,
   *  open source, directory, streaming. Written for templates 22-32,
   *  and each one carries the screen its genre is actually recognised
   *  by rather than a SaaS page with the nouns swapped -- the menu as a
   *  bill of fare, the agenda across tracks, the map beside the
   *  results, the watch screen.
   * ---------------------------------------------------------------- */
  {
    id: 'developer-portfolio-page',
    ...
    tags: ['portfolio', 'developer', 'personal', 'hire me', 'engineer'],
    previewComponent: 'developer-portfolio-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-terminal',
  ...
  },
  {
    ...
    tags: ['crypto', 'fintech', 'exchange', 'trading', 'regulated'],
    previewComponent: 'crypto-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'price-ticker-strip',
  ...
  },
  {
    ...
    tags: ['markets', 'prices', 'crypto', 'fintech', 'data'],
    previewComponent: 'markets-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'price-ticker-strip',
  ...
  },
  {
    ...
    tags: ['conference', 'event', 'tickets', 'speakers', 'agenda'],
    previewComponent: 'event-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'announcement-bar',
      'navbar-simple',
  ...
  },
  {
    ...
    tags: ['agenda', 'programme', 'schedule', 'conference', 'tracks'],
    previewComponent: 'schedule-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'event-agenda-grid',
  ...
  },
  {
    ...
    previewComponent: 'restaurant-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-media-overlay',
  ...
  },
  {
    ...
    tags: ['menu', 'restaurant', 'food', 'wine', 'allergens'],
    previewComponent: 'menu-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'menu-course-list',
  ...
  },
  {
    ...
    tags: ['booking', 'reservation', 'restaurant', 'availability', 'scheduling'],
    previewComponent: 'reservation-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-booking',
  ...
  },
  {
    ...
    tags: ['real estate', 'property', 'search', 'map', 'estate agency'],
    previewComponent: 'property-search-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-search',
  ...
  },
  {
    ...
    tags: ['real estate', 'property', 'listing', 'viewing', 'detail'],
    previewComponent: 'property-detail-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'product-gallery',
  ...
  },
  {
    ...
    tags: ['job board', 'hiring', 'careers', 'marketplace', 'salary'],
    previewComponent: 'job-board-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-search',
  ...
  },
  {
    ...
    tags: ['job', 'listing', 'hiring', 'application', 'careers'],
    previewComponent: 'job-detail-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'article-header',
  ...
  },
  {
    ...
    tags: ['newsletter', 'email', 'subscribe', 'archive', 'writing'],
    previewComponent: 'newsletter-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-waitlist',
  ...
  },
  {
    ...
    tags: ['open source', 'oss', 'developer tool', 'library', 'github'],
    previewComponent: 'oss-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'code-tabs-panel',
  ...
  },
  {
    ...
    tags: ['directory', 'listings', 'search', 'facets', 'index'],
    previewComponent: 'directory-index-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-search',
  ...
  },
  {
    ...
    tags: ['directory', 'listing', 'comparison', 'reviews', 'detail'],
    previewComponent: 'directory-listing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'article-header',
  ...
  {
    id: 'streaming-landing-page',
    name: 'Streaming Service Landing',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['streaming', 'video', 'subscription', 'catalogue', 'media'],
    previewComponent: 'streaming-landing-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-media-overlay',
  ...
  },
  {
    ...
    tags: ['video', 'watch', 'player', 'streaming', 'transcript'],
    previewComponent: 'watch-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'video-player-shell',
