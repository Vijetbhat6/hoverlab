...
export interface PageRecord {
  ...
  composedOf: string[]
  /** Take 01's id, on a second take only. See `Page['takeOf']`. */
  takeOf?: string
  tier?: ArtifactTier
  featured?: boolean
  darkSurface?: boolean
...
export const PAGE_CATALOG: PageRecord[] = [
...

  {
    ...
    tags: ['about', 'company', 'story', 'team', 'timeline'],
    previewComponent: 'about-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'stats-narrative',
  ...
  },
  {
    ...
    tags: ['contact', 'support', 'form', 'faq', 'enquiry'],
    previewComponent: 'contact-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'contact-form-split',
  ...
  },
  {
    ...
    tags: ['team', 'people', 'culture', 'about', 'how we work'],
    previewComponent: 'team-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'team-grid',
  ...
  },
  {
    ...
    tags: ['faq', 'questions', 'search', 'objections', 'pre-sale'],
    previewComponent: 'faq-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'faq-search',
  ...
  },
  {
    ...
    tags: ['case study', 'customer story', 'results', 'proof', 'before after'],
    previewComponent: 'case-study-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'article-header',
  ...
  },
  {
    ...
    tags: ['case studies', 'customers', 'index', 'proof', 'industries'],
    previewComponent: 'case-study-index-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'testimonial-ratings',
  ...
  },
  {
    ...
    tags: ['services', 'agency', 'consulting', 'engagements', 'pricing'],
    previewComponent: 'services-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'persona-cards',
  ...
  },
  {
    ...
    tags: ['integrations', 'directory', 'connectors', 'api', 'partners'],
    previewComponent: 'integrations-index-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-integrations',
  ...
  },
  {
    ...
    tags: ['integration', 'connector', 'sync', 'api', 'setup'],
    previewComponent: 'integration-detail-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'article-header',
  ...
  },
  {
    ...
    tags: ['comparison', 'alternatives', 'versus', 'competitors', 'matrix'],
    previewComponent: 'alternatives-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'comparison-table',
  ...
  },
  {
    ...
    tags: ['status', 'uptime', 'incident', 'maintenance', 'availability'],
    previewComponent: 'status-page',
    deps: ['lucide-react'],
    composedOf: [
  ...
  },
  {
    ...
    tags: ['roadmap', 'changelog', 'public', 'planned', 'shipped'],
    previewComponent: 'roadmap-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'roadmap-columns',
  ...
  },
  {
    ...
    tags: ['webinar', 'event', 'registration', 'agenda', 'live'],
    previewComponent: 'webinar-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-booking',
  ...
  },
  {
    ...
    tags: ['coming soon', 'waitlist', 'pre-launch', 'email capture', 'teaser'],
    previewComponent: 'coming-soon-page',
    deps: ['lucide-react'],
    composedOf: [
      'hero-waitlist',
      'feature-rows',
  ...
  },
  {
    ...
    tags: ['community', 'forum', 'discord', 'groups', 'digest'],
    previewComponent: 'community-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'community-band',
  ...
  },
  {
    ...
    tags: ['affiliate', 'partners', 'referral', 'commission', 'programme'],
    previewComponent: 'affiliate-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'stats-band',
  ...
  },
  {
    ...
    tags: ['testimonials', 'reviews', 'social proof', 'ratings', 'wall'],
    previewComponent: 'testimonials-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'testimonial-ratings',
  ...
  },
  {
    ...
    tags: ['gallery', 'showcase', 'screens', 'product tour', 'visual'],
    previewComponent: 'gallery-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-media-overlay',
  ...
  },
  {
    ...
    tags: ['portfolio', 'studio', 'work', 'freelance', 'projects'],
    previewComponent: 'portfolio-index-page',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-editorial',
   ...
   *  Second takes
   *
   *  Each of these pairs with the page named in its `takeOf` and makes
   *  the opposite bet about who is reading. They are not restyles: the
   *  docblock at the top of every source argues for the trade it makes
   *  and names the case where the other take wins. See Page['takeOf'].
   * ---------------------------------------------------------------- */
  {
    id: 'about-page-02',
    name: 'About Page 02',
    ...
    tags: ['about', 'company', 'founder letter', 'hiring', 'story'],
    previewComponent: 'about-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-editorial',
  ...
  },
  {
    ...
    tags: ['contact', 'routing', 'booking', 'support', 'forms'],
    previewComponent: 'contact-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'persona-cards',
  ...
  },
  {
    ...
    tags: ['team', 'hiring', 'careers', 'culture', 'salary bands'],
    previewComponent: 'team-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-split',
  ...
  },
  {
    ...
    tags: ['faq', 'objections', 'security', 'questions', 'sales'],
    previewComponent: 'faq-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'faq-objection-list',
  ...
  },
  {
    ...
    tags: ['case study', 'customer story', 'narrative', 'benchmark', 'proof'],
    previewComponent: 'case-study-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-testimonial',
    ...
    takeOf: 'case-study-page',
  },
  {
    id: 'case-study-index-page-02',
    name: 'Case Study Index 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['case studies', 'directory', 'search', 'facets', 'customers'],
    previewComponent: 'case-study-index-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-search',
    ...
    takeOf: 'case-study-index-page',
  },
  {
    id: 'services-page-02',
    name: 'Services Page 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['services', 'productised', 'fixed price', 'consulting', 'engagement'],
    previewComponent: 'services-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-price-anchor',
    ...
    takeOf: 'services-page',
  },
  {
    id: 'integrations-index-page-02',
    name: 'Integrations Index 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['integrations', 'directory', 'search', 'facets', 'connectors'],
    previewComponent: 'integrations-index-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-search',
    ...
    takeOf: 'integrations-index-page',
  },
  {
    id: 'integration-detail-page-02',
    name: 'Integration Detail 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['integration', 'setup', 'wizard', 'api', 'security'],
    previewComponent: 'integration-detail-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'integration-depth-split',
    ...
    takeOf: 'integration-detail-page',
  },
  {
    id: 'alternatives-page-02',
    name: 'Alternatives Page 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['alternatives', 'comparison', 'migration', 'switching', 'competitor'],
    previewComponent: 'alternatives-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-split',
  ...
  },
  {
    ...
    tags: ['status', 'uptime', 'incidents', 'post-mortem', 'diligence'],
    previewComponent: 'status-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'stats-band',
  ...
  },
  {
    ...
    tags: ['roadmap', 'themes', 'declined', 'no dates', 'feedback'],
    previewComponent: 'roadmap-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-editorial',
  ...
  },
  {
    ...
    tags: ['webinar', 'replay', 'on-demand', 'video', 'transcript'],
    previewComponent: 'webinar-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-media-overlay',
  ...
  },
  {
    ...
    tags: ['coming soon', 'waitlist', 'referral', 'queue', 'launch'],
    previewComponent: 'coming-soon-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'hero-centered',
      'stats-band',
  ...
  },
  {
    ...
    tags: ['legal', 'terms', 'plain language', 'cookies', 'compliance'],
    previewComponent: 'legal-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'article-header',
  ...
  {
    id: 'community-page-02',
    name: 'Community Page 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['community', 'events', 'calendar', 'office hours', 'user group'],
    previewComponent: 'community-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-booking',
    ...
    takeOf: 'community-page',
  },
  {
    id: 'affiliate-page-02',
    name: 'Affiliate Page 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['affiliate', 'partners', 'commission', 'referral', 'programme'],
    previewComponent: 'affiliate-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-metrics',
    ...
    takeOf: 'affiliate-page',
  },
  {
    id: 'testimonials-page-02',
    name: 'Testimonials Wall 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['testimonials', 'reviews', 'personas', 'social proof', 'ratings'],
    previewComponent: 'testimonials-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-testimonial',
    ...
    takeOf: 'testimonials-page',
  },
  {
    id: 'gallery-page-02',
    name: 'Gallery Page 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['gallery', 'catalogue', 'filters', 'grid', 'collection'],
    previewComponent: 'gallery-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'collection-toolbar',
  ...
  {
    id: 'portfolio-index-page-02',
    name: 'Portfolio Index 02',
    category: 'Marketing Pages',
    description:
    ...
    tags: ['portfolio', 'studio', 'projects', 'case studies', 'brief'],
    previewComponent: 'portfolio-index-page-02',
    deps: ['lucide-react'],
    composedOf: [
      'navbar-simple',
      'hero-media-overlay',
