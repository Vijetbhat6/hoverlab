...
const DEFAULT_STATE = PALETTE_DEFAULTS
      ...
      <ToolWorkbench previewSide="right" controlsWidth="380px">
        ...
        <div className="space-y-6">
          ...
          */}
          ...
          <OpenInStudio
            params={{ base: base.replace(/^#/, ''), scheme }}
            gap="Five harmonious colours are a starting point, not a design system — a UI has one accent, a scale of neutrals, a radius and a typeface, and this page produces none of those."
          />
        </div>
