 ...
 *
 * A component rather than the route itself. The route is a server
 * component now, so the hub's ItemList structured data can be emitted from
 * HTML instead of from the client bundle — and it cannot go in
 * `app/tools/layout.tsx`, which wraps all twenty tool routes as well and
 * would stamp the hub's list onto every one of them.
 */
